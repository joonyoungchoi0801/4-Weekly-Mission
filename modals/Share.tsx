...
function Share({ title, main, onClose, currentFolderId }: Props) {
  const shareUrl = `${window.location.origin}/folder/${currentFolderId}`;
  ...
  return (
    <Background>
      <Container>
        <Image className="close" src={closeIcon} alt="closeButton" onClick={onClose}></Image>
        <TitleContainer>
        ...
        <ShareContainer>
          <LinkContainer color={'kakao'} onClick={shareKakao}>
            <div className="shareImgSection">
              <Image src={kakaoIcon} alt="kakaoIcon"></Image>
            </div>
          ...
          <LinkContainer color={'link'} onClick={copyToClipboard}>
            <div className="shareImgSection">
              <Image className="link" src={linkIcon} alt="linkIcon"></Image>
            </div>
