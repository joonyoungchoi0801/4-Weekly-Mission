...
`;
const AddFolderImgWrapper = styled.div`
  width: 16px;
  height: 16px;
`;
    ...
    <Wrapper>
      <Container>
        ...
        <AddContainer as="button" onClick={handleOpenEdit}>
          ...
          <AddFolderImgWrapper>
            <Image src={currentIcon} alt="addIcon" />
          </AddFolderImgWrapper>
        </AddContainer>
        {isEditModalSelected &&
      ...
      <Container>
        ...
        <OptionContainer $isHidden={selectedFolder.id === null}>
          <OptionImgWrapper>
            <Image src={shareIcon} alt="sharedIcon" onClick={handleOpenShare} />
          </OptionImgWrapper>
          <OptionText onClick={handleOpenShare}>공유</OptionText>
          <OptionImgWrapper>
            <Image src={penIcon} alt="penIcon" onClick={handleOpenFolderNameChange} />
          </OptionImgWrapper>
          <OptionText onClick={handleOpenFolderNameChange}>이름 변경</OptionText>
          <OptionImgWrapper>
            <Image src={deleteIcon} alt="deleteIcon" onClick={() => handleOpenDelete(selectedFolder.id)} />
          </OptionImgWrapper>
