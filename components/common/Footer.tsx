    ...
    <div ref={footerRef} className={styles.footer}>
      <div className={styles.footerBox}>
        ...
        <div className={styles.centerfooter}>
          <Link className={styles.centerlink} href="https://www.codeit.kr/subscription">
            Privacy Policy
          </Link>
        ...
        <div className={styles.endfooter}>
          <Link href="https://www.facebook.com/">
            <Image className={styles.endimg} src={facebookIcon} alt="facebook"></Image>
          </Link>
          <Link href="https://twitter.com/home?lang=ko">
            <Image className={styles.endimg} src={twitterIcon} alt="twitter"></Image>
          </Link>
          <Link href="https://www.youtube.com/">
            <Image className={styles.endimg} src={youtubeIcon} alt="youtube"></Image>
          </Link>
          <Link href="https://www.instagram.com/">
            <Image className={styles.endimg} src={instagramIcon} alt="instagram"></Image>
          </Link>
        </div>
      </div>
    </div>
